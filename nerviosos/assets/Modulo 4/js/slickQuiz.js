...
var quizJSON = {
    "info": {
        "name":    "Test!!",
        "main":    "<p style='text-align:center;'><small>Seleccione la respuesta que considere correcta.</small></p>",
        "results": "<h1 style='text-align:center;'>Gracias por realizar la prueba de entrada.</h1><br><div style='position:absolute; margin-top:200px;'><p style='text-align:left;'><a href='#close' class='wow fadeInUp btn'><< Regresar</a></div></p>"
        
    },
    "questions": [
        { // Question 1 - 
            "q": "La convivencia es un elemento:",
            "a": [
                {"option": "a. Construido por las otras personas y enseñado a cada individuo.",      "correct": false},
                {"option": "b.	De construcción individual.",     "correct": false},
                {"option": "c.	Construido constantemente por todas las personas.",      "correct": true},
                {"option": "d.	Construido cada cierto tiempo.",      "correct": false} // no comma 
            ],
            "correct": "<p><span>Muy bien.</span></p>",
            "incorrect": "<p><span>Incorrecto.</span></p>" // no comma here
        },
        { // Question 2 - 
            "q": "Es necesario trabajar en la convivencia en propiedad horizontal para:",
            "a": [
                {"option": "a.	Mejorar la armonía del hogar.",      "correct": false},
                {"option": "b.	Evitar las quejas en las oficinas de administración.",     "correct": false},
                {"option": "c.	Generar entornos amables para todos los habitantes.",      "correct": true},
                {"option": "d.	No incumplir las leyes nacionales.",     "correct": false} // no comma 
            ],
            "correct": "<p><span>Muy bien.</span></p>",
            "incorrect": "<p><span>Incorrecto.</span></p>" // no comma here
        },
        { // Question 3 - 
            "q": "¿Qué se logra con la convivencia social?",
            "a": [
                {"option": "a.	Comunidades solidarias y organizadas.",      "correct": true},
                {"option": "b.	Celebraciones de días especiales.",     "correct": false},
                {"option": "c.	Saludo y amabilidad entre todos.",      "correct": false},
                {"option": "d.	Menos problemas en el hogar.",     "correct": false} // no comma 
            ],
            "correct": "<p><span>Muy bien.</span></p>",
            "incorrect": "<p><span>Incorrecto.</span></p>" // no comma here
        },
        { // Question 4 - 
            "q": "La planeación estratégica permite en la propiedad horizontal:",
            "a": [
                {"option": "a.	Priorizar, planificar y ejecutar lo que necesita la copropiedad.",      "correct": true},
                {"option": "b.	Cambiar las cuotas de administración.",     "correct": false},
                {"option": "c.	Mejorar la convivencia en la propiedad horizontal.",      "correct": false},
                {"option": "d.	Multar a los infractores.",     "correct": false} // no comma 
            ],
            "correct": "<p><span>Muy bien.</span></p>",
            "incorrect": "<p><span>Incorrecto.</span></p>" // no comma here
        },
        { // Question 5 - 
            "q": "La planeación estratégica requiere:",
            "a": [
                {"option": "a.	Definir el problema, estrategia, actividades y responsables.",      "correct": false},
                {"option": "b.	Definir cronograma, presupuesto, metas e indicadores de gestión. ",     "correct": false},
                {"option": "c.	No priorizar las necesidades.",      "correct": false},
                {"option": "d.	A y B.",     "correct": true} // no comma 
            ],
            "correct": "<p><span>Muy bien.</span></p>",
            "incorrect": "<p><span>Incorrecto.</span></p>" // no comma here
        },
        { // Question 6 - 
            "q": "La inteligencia emocional es:",
            "a": [
                {"option": "a.	Capacidad de reconocer nuestros propios sentimientos y los ajenos.",      "correct": true},
                {"option": "b.	Buenas intenciones.",     "correct": false},
                {"option": "c.	Una capacidad colectiva.",      "correct": false},
                {"option": "d.	Una habilidad.",     "correct": false} // no comma 
            ],
            "correct": "<p><span>Muy bien.</span></p>",
            "incorrect": "<p><span>Incorrecto.</span></p>" // no comma here
        },
        { // Question 7 - 
            "q": "Una de las siguientes no es una habilidad social:",
            "a": [
                {"option": "a.	Influencia.",      "correct": false},
                {"option": "b.	Trabajo en equipo.",     "correct": false},
                {"option": "c.	Manejo de conflictos.",      "correct": false},
                {"option": "d.	Autoconocimiento.",     "correct": true} // no comma 
            ],
            "correct": "<p><span>Muy bien.</span></p>",
            "incorrect": "<p><span>Incorrecto.</span></p>" // no comma here
        },
...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'Validar respuesta',
                nextQuestionText: 'Siguiente &raquo;',
                backButtonText: '&laquo; Volver a responder',
                completeQuizText: '',
                tryAgainText: 'Responder de nuevo',
                questionCountText: '',
